...
public class Sprite {
	...
	public static Sprite powerup_speed = new Sprite(DEFAULT_SIZE, 1, 10, SpriteSheet.tiles, 16, 16);
	public static Sprite powerup_bombpass = new Sprite(DEFAULT_SIZE, 2, 10, SpriteSheet.tiles, 16, 16);
	...
	public static Sprite powerup_flames = new Sprite(DEFAULT_SIZE, 5, 10, SpriteSheet.tiles, 16, 16);
