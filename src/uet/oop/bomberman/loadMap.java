...
public class loadMap {
    ...
    //private static String input_Level3 = "C:\\Users\\quang\\Desktop\\Bomberman-Game\\res\\levels\\3.txt";
            ...
            while (scanner.hasNextLine()) {
                ...
                for (int  i = 0; i < s.length(); i++) {
                    ...
                    if (s.charAt(i) == '#') {
                        ...
                        if (k == 0) {
                            stillObjects.add(new Flame_Item(i, j, Sprite.powerup_flames.getFxImage()));
                        }
                        if (k == 1) {
